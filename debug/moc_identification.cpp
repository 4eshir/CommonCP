...
const QMetaObject Identification::staticMetaObject = {
    { &BaseWindow::staticMetaObject, qt_meta_stringdata_Identification.data,
      qt_meta_data_Identification,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Identification::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Identification.stringdata0))
        return static_cast<void*>(const_cast< Identification*>(this));
